...
│       │   ├── enums/                # UserRole, MovieType, MovieStatus...
...
└── client/                          # Frontend — React (Vite)
    └── src/
        ...
        ├── lib/                      # axiosClient.js, queryClient.js
        ├── routes/                   # AppRoutes, ProtectedRoute, AdminRoute
        ├── config/                   # constants.js
        └── features/
            ├── auth/       (api · hooks · pages)
            ├── movies/     (api · hooks · pages)
            ├── comments/   (api · hooks)
            ├── interactions/ (favorites · ratings · watchlist · history)
            ├── notifications/
            └── admin/
```
